...
def create_pipeline_model_output_demo(**kwargs):
    return Pipeline(
        [
            node(
                func=train_model,
            ...
            node(
                func=predict,
                inputs=dict(model="mod_example_model", test_x="modin_example_test_x"),
                outputs="modout_example_predictions",
            ),
            node(
                func=report_accuracy,
                inputs=["modout_example_predictions", "modin_example_test_y"],
                outputs=None,
            ),
        ],
        tags=["demo", "model_output"],
    )
